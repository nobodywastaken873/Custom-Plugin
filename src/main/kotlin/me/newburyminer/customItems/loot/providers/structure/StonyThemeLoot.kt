...
object StonyThemeLoot: ThemeLootProvider {
    override val consumableTable: LootTable = weighted(2..8,
        ...
        custom(CustomItem.MINERS_PIE, 1..2) to 2.0,
        custom(CustomItem.TURTLE_MEAT, 1..2) to 2.5,
    ...
    override val cosmeticsTable: LootTable = weighted(1..6,
        ...
        custom(CustomItem.COAL_TRIM, 1..2) to 1.5,
        custom(CustomItem.NETHER_BRICK_TRIM, 1..2) to 1.5,
    )
}
