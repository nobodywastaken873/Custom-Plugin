...
class TotemOfContinuation: CustomItemDefinition {

    override val custom: CustomItem = CustomItem.TOTEM_OF_CONTINUATION

    private val material = Material.TOTEM_OF_UNDYING
    private val color = arrayOf(92, 179, 219)
    private val name = Utils.text("Totem of Continuation", color)
    private val lore = Utils.loreBlockToList(
        Utils.text("Gives the same effects as a normal totem, but does not remove all active effects.", Utils.GRAY),
    )
