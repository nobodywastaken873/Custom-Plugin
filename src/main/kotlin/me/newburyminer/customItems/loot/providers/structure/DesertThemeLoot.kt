...
object DesertThemeLoot: ThemeLootProvider {
    override val consumableTable: LootTable = weighted(2..8,
        material(Material.GOLDEN_APPLE, 1..2) to 6.0,
        material(Material.ENCHANTED_GOLDEN_APPLE, 1..1) to 1.0,
        material(Material.TOTEM_OF_UNDYING, 1..1) to 1.9,
        custom(CustomItem.KFC_BUCKET, 4..8) to 7.0,

        custom(CustomItem.TOTEM_OF_TELEPORTATION, 1..1) to 1.5,
        custom(CustomItem.GOLDEN_FRIES, 1..2) to 1.5,
        custom(CustomItem.GOLDEN_CHORUS_FRUIT, 1..2) to 2.5,
    ...
    override val cosmeticsTable: LootTable = weighted(1..6,
        ...
        custom(CustomItem.AMBER_POTATO, 1..2) to 1.0,
        custom(CustomItem.SLIME_TRIM, 1..2) to 1.0,
    )
}
