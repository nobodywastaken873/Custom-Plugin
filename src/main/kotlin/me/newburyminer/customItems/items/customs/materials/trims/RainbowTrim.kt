...
class RainbowTrim: CustomItemDefinition {

    override val custom: CustomItem = CustomItem.RAINBOW_TRIM

    private val material = Material.ENCHANTED_GOLDEN_APPLE
    private val color = arrayOf(255, 255, 255)
    private val name = text("Rainbow Palette", color)
    ...
    private val trimMaterial = RegistryAccess.registryAccess()
        ...
        .get(Key.key("customworld", "rainbow")) ?: TrimMaterial.IRON
