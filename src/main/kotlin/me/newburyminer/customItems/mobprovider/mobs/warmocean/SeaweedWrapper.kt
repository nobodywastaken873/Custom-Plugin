    ...
    override fun build(ctx: MobContext): MobBuilder = mob(EntityType.SKELETON) {
        ...
        ability(
            ProjectileEffectAbility(
                ...
                attribute(Attribute.MOVEMENT_SPEED, linear(-0.5 to -0.8, ctx), AttributeModifier.Operation.ADD_SCALAR, linear(40 to 60, ctx)),
                attribute(Attribute.JUMP_STRENGTH, linear(-0.5 to -0.8, ctx), AttributeModifier.Operation.ADD_SCALAR, linear(40 to 60, ctx)),
            )
        )
