...
class GoldenChorusFruit: CustomItemDefinition {

    override val custom: CustomItem = CustomItem.GOLDEN_CHORUS_FRUIT

    private val material = Material.GOLDEN_APPLE
    private val color = arrayOf(190, 132, 209)
    private val name = text("Golden Chorus Fruit", color)
