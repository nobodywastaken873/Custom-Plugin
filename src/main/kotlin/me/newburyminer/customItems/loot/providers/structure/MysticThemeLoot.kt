...
object MysticThemeLoot: ThemeLootProvider {
    override val consumableTable: LootTable = weighted(2..8,
        material(Material.GOLDEN_APPLE, 1..2) to 6.0,
        material(Material.ENCHANTED_GOLDEN_APPLE, 1..1) to 0.8,
        material(Material.TOTEM_OF_UNDYING, 1..1) to 1.8,
        material(Material.GOLDEN_CARROT, 4..8) to 7.0,

        custom(CustomItem.TOTEM_OF_ESCAPE, 1..1) to 1.5,
        custom(CustomItem.INSTANT_GOLDEN_APPLE, 1..2) to 2.0,
        custom(CustomItem.PHANTOM_CARCASS, 1..2) to 2.5,
        custom(CustomItem.GOLDEN_CHORUS_FRUIT, 1..2) to 2.0,
    ...
    override val cosmeticsTable: LootTable = weighted(1..6,
        ...
        custom(CustomItem.CHORUS_TRIM, 1..2) to 1.0,
        custom(CustomItem.PASTEL_PINK, 1..2) to 1.0,
        custom(CustomItem.DRAGON_TRIM, 1..2) to 1.0,
    )
}
