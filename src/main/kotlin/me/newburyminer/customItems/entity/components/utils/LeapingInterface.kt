...
interface LeapingInterface {
    ...
    fun calculateLeapVelocity(start: Location, end: Location, extraHeight: Double, grav: Double = 0.08): Vector {

        val distanceVect = start.clone().subtract(end).toVector()
