...
class AqueousSandals: CustomItemDefinition {
    ...
    override val item: ItemStack = CustomItemBuilder(material, custom)
        ...
        .setAttributes(
            ...
            SimpleModifier(Attribute.WATER_MOVEMENT_EFFICIENCY, 1.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.FEET),
            SimpleModifier(Attribute.SUBMERGED_MINING_SPEED, 1.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.FEET),
            SimpleModifier(Attribute.MOVEMENT_SPEED, 0.01, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.FEET),
        )
        .build()
