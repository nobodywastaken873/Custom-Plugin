...
class StructureLoot2(private val normalSpawner: CustomLootTable, private val ominousSpawner: CustomLootTable,
...
enum class CustomStructure2(var text: String = "", var tag: String = "") {
    ...
    lateinit var loot: StructureLoot2
    ...
    companion object {
        init {
            ABANDONED_SHIP.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            AGED_OCEAN_MONUMENT.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            BADLANDS_OUTPOST.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            BLACK_TOWERS.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            DEEP_BLUE_CITY.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            DESERT_COURTYARD.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            DESERT_MOSQUE.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            DESERT_RUINS.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            DESERT_TEMPLE.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            DETERIORATED_BRIDGE.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            DROWNED_OUTPOST.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            JUNGLE_TEMPLE.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            LITTLE_MUD_FORT.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            MANGROVE_HOUSE.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            MARBLE_FORT.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            MASSIVE_DESERT_TEMPLE.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            MASSIVE_OCEAN_MONUMENT.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            OCEAN_QUARRY.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            OCEAN_RUINS.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            PURPLE_TOWERS.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
            ...
            STONE_FORT.loot = StructureLoot2(
                // Normal Spawner
                CustomLootTable(
                    RandomSelector(
        ...
        fun get(tag: String): CustomStructure2 {
            for (structure in CustomStructure2.entries) {
                if (structure.tag == tag) {
                    return structure
                }
            }
            return CustomStructure2.entries.first()
        }
    }
}