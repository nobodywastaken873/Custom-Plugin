...
class MinersBoots: CustomItemDefinition {

    override val custom: CustomItem = CustomItem.MINERS_BOOTS

    private val material = Material.NETHERITE_BOOTS
    private val color = arrayOf(122, 119, 69)
    private val name = text("Miner's Boots", color)
    ...
    override val item: ItemStack = CustomItemBuilder(material, custom)
        ...
        .setAttributes(
            ...
            SimpleModifier(Attribute.MINING_EFFICIENCY, 10.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.FEET),
        )
